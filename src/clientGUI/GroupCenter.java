/* Name: GroupCenter.java 
 * Description: 小组待办中间界面
...
public class GroupCenter extends JPanel{
	...
	//set the right frame
	public void setRight(GroupRight rightframe) {
		this.rightframe = rightframe;
	}
	
	//create a group TODO
	public void createGroupTodo() {
	...
	//show a group TODO
	public void showGroupTodo(GroupTodo gtodo) {
		//set the component of the Panel
		nameText.setEditable(false);
		timePick.setEditable(false);
		content.setEditable(false);
		nameText.setText(gtodo.getTitle());
		timePick.setDate(gtodo.getDate());
		content.setText(gtodo.getContent());
		buttonPanel.removeAll();
	...
	private class EnterHandler implements ActionListener {
		//declare private attributes
		private GroupCenter centerframe;
		private String title;
		private Date time;
		private String cont;
		//constructor
		public EnterHandler(GroupCenter centerframe) {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(!title.equals("")) {
				...
				GroupTodo gtodo = new GroupTodo(title,time, cont);
				rightframe.addGroupTodo(gtodo);
				connection.sendGroupTodo(gtodo,account);
